...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-@0z$9fp7cdl8$*toz#xneq9!*op(0mtx^9$d0=!@2ux_ab#+b$'
)
...
# ================================================================
# ✅ Banco de dados: SQLite no local, PostgreSQL no Render
# ================================================================
...
INTERNAL_IPS = ['127.0.0.1', 'localhost']  # Para o debug_toolbar
